  ...
  return (
    ...
    <div id="aboutus" className="p-0 md:p-12 flex justify-center items-center">
      ...
      <div className="hidden sm:flex flex-col justify-center items-center m-[2.5rem] w-[30%] sm:max-lg:w-[50%]">
        <img
          src="/public/images/about-us-1.png"
          className="scale-[1.08] max-w-full h-auto"
        />
        <img
          src="/public/images/about-us-2.png"
          className="max-w-full h-auto"
        />
      </div>
      {/* Text DIV */}
      <div className="w-[50%] max-sm:w-full max-sm:p-[1.5rem] text-[24px] max-sm:text-[16px] sm:max-md:text-[16px]">
        <h2 className="text-[#2D3E6A] text-[40px] max-sm:text-[24px] sm:max-md:text-[28px] font-medium">
          About Us
        </h2>
        <p className="mb-[1rem]">
